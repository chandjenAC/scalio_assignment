...
import { getBillingProjectSummaryForPendingApproval } from "../../utils/getData";
...
const StatementsPendingApprovalContainer = (props) => {
  ...
  const {
    ...
    getBillingProjectSummaryForPendingApproval,
    {
  ...
  const retrieveStatementDetails = (rowData) => {
    ...
    navigate(`/yogi-webb/billing/statements/pendingApproval/${rowData.id}`);
  };
        ...
        >
          ...
          <Grid item>
            <ActivityFilters
              ...
              loadPendingApprovalCustomers={true}
...
export default StatementsPendingApprovalContainer;
