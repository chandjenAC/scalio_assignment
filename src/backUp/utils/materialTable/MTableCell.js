...
import TruncateAndCopy from "../../components/common/molecules/TruncateAndCopy";
  ...
  getRenderValue() {
    ...
    if (this.props.columnDef.render) {
      ...
      if (this.props.value instanceof Date) {
        ...
        return (
          <Typography variant="caption" style={{ fontWeight:600 }}>
            {parseISO(this.props.value).toLocaleString(dateLocale)}
          </Typography>
        );
      } else {
        return <Typography variant="caption" style={{ fontWeight:600 }}>{this.props.value}</Typography>;
      }
    ...
    return (
      this.props.value && (
        <TruncateAndCopy
          ...
          truncate={!this.props.columnDef.dontTruncate}
          copy={this.props.columnDef.copy}
        />
      )
    );
  }
